...
class RoleController extends Controller
{
    ...
    {
        $list_per_page = 10;
        $roles = Role::orderBy('id','DESC')->paginate($list_per_page);
        return view('roles.index',['roles'=>$roles,'title'=>'Role Listing'])
    ...
    public function create()
    {
        ...
        return view('roles.create',['permission'=>$permission,'title'=>'Create Permission'] );
    }
