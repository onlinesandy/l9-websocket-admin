<div>
            ...
            <ul class="list-unstyled media-block">
                <li class="mar-btm">
                    ...
                    <div class="media-body pad-hor">
                        <div class="speech">
                            <a href="#" class="media-heading">Sandy Chavez</a>
                ...
                <li class="mar-btm">
                    <div class="media-right">
                        <img src="img/profile-photos/8.png" class="img-circle img-sm"
                            alt="Profile Picture">
                    </div>
                    <div class="media-body pad-hor speech-right">
                        <div class="speech">
    ...
    @error('chat-message') <div class="error mt-2">{{ $message }}</div> @enderror
</div>
</div>
